...
public class PlayerManager : MonoBehaviour
{
    ...
    private void Update()
    {
        //FormatStickMan();     TEST ÝÇÝN BURADA
        ...
        #region player düþmaný takip eder
        if (battleManager.attackState)
        {
            //savaþ baþladýysa player düþmanlarý takip eder.
    ...
    public IEnumerator FormatStickMan()            //göze daha hoþ görüldüðü için IEnumerator yapýldý. EÐER AKSÝLÝK ÇIKARTIRSA GERÝ VOÝD HALÝNE DÖNDÜRÜLECEK
    {
        for (int i = 1; i < transform.childCount; i++)
        {
