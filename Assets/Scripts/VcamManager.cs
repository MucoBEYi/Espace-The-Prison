...
public class VCamManager : MonoBehaviour
{
    ...
    {
        Vector3 playerOffset = new Vector3(0, 5.37f, -7.31f);

        if (player.childCount <= 29)
            playerOffset = new Vector3(0, 5.37f, -7.31f);
        else if (player.childCount >= 30 && player.childCount <= 60)
            playerOffset = new Vector3(0, 5.87f, -7.81f);
        else if (player.childCount >= 61 && player.childCount <= 90)
            playerOffset = new Vector3(0, 6.37f, -8.31f);
        else if (player.childCount >= 91 && player.childCount <= 120)
            playerOffset = new Vector3(0, 6.87f, -8.81f);
        else if (player.childCount >= 121 && player.childCount <= 150)
            playerOffset = new Vector3(0, 7.37f, -9.31f);
        else if (player.childCount >= 151 && player.childCount <= 180)
            playerOffset = new Vector3(0, 7.87f, -9.81f);
        else if (player.childCount >= 181)
            playerOffset = new Vector3(0, 8.87f, -10.81f);
